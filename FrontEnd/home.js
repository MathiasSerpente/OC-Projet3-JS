...
modalButtonValidForm.addEventListener("click", function () {
    const test = modalButtonValidForm.hasAttribute("disabled");
    console.log(test);
    // if (modalButtonValidForm.getAttribute("disabled"))
});
